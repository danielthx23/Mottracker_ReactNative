...
const PatioListDashboard: React.FC<PatioListProps> = ({ 
  ...
  // Dados para o gráfico - Top 8 pátios com mais motos
  const topPatios = [...filteredPatios]
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.dashboardRow}>
        ...
        >
          <Text style={styles.cardLabel}>Total Pátios</Text>
          <Text style={styles.cardValue}>{totalPatios}</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.cardLabel}>Total Motos</Text>
          <Text style={styles.cardValue}>{totalMotos}</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.cardValue}>{totalDisponiveis}</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.cardLabel}>Taxa Ocupação</Text>
          <Text style={styles.cardValue}>{taxaOcupacao}%</Text>
        </TouchableOpacity>
      </View>
        ...
        <VictoryChart theme={VictoryTheme.material} height={280} padding={{ left: 40, top: 40, right: 40, bottom: 60 }}>
          ...
          <VictoryAxis
            ...
            style={{
              axis: { stroke: '#f9fafb' },
              ticks: { stroke: '#f9fafb' },
              tickLabels: { fontSize: 10, fill: '#f9fafb', angle: -45 },
            }}
          />
          <VictoryAxis
            dependentAxis
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <TouchableOpacity
          style={styles.createPatioButton}
          onPress={onCreatePatio}
        >
          <Ionicons name="add" size={20} color="#0c0c0c" />
          <Text style={styles.createPatioButtonText}>Novo Pátio</Text>
        </TouchableOpacity>
      </View>
